...
async function axiosWrapper(method = "GET", url, body, headers = {}, params = {}, streamToFile = false, streamToFileName = null, dataFromFile = "", throwError = true, pagination = false, cursorKey = "", cursorAppendMethod = "query", cursorParamName = "cursor", maxPages = null) {
    let dataToSend = body;
    ...
    if (streamToFile || dataFromFile) {
        throw new Error("Pagination is not supported with streamToFile or dataFromFile options");
    }
    do {
        pageCount++;
        ...
        try {
            const res = await (0, axios_1.default)(paginationOptions);
...
const handler = async (inputs) => {
    const { method = "GET", url, body, headers, params, streamToFile, streamToFileName, dataFromFile, throwError, pagination = false, cursorKey = "", cursorAppendMethod = "query", cursorParamName = "cursor", maxPages = null, } = inputs;
    const response = await axiosWrapper(method, url, body, headers, params, streamToFile, streamToFileName, dataFromFile, throwError, pagination, cursorKey, cursorAppendMethod, cursorParamName, maxPages);
